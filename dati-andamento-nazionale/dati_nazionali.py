...
plt.figure()
plt.plot(nazionale_df.index.values,nazionale_df['totale_casi'],label='totale casi',marker='x')
plt.plot(nazionale_df.index.values,casi_attivi,label='casi attivi')
plt.plot(nazionale_df.index.values, exp_func(x, *popt1), 'r-', label="Fitted Curve - casi totali")
plt.plot(nazionale_df.index.values, exp_func(x, *popt2), 'r-', label="Fitted Curve - casi attivi")
